-- Fix: auth_user_id column is now UUID (changed by migration 000001).
-- Migration 000002 incorrectly cast auth_user_uuid to text, causing uuid = text.
-- This migration recreates all 6 impl functions with direct uuid = uuid comparisons.
